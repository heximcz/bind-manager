...
abstract class AbstractBindManager extends AbstractBindStatistics {
	...
	protected function testDomainZone() {
	...
	protected function testBindService() {
	...
	protected function checkErrorEmail() {
